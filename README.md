...
<p align="center">
  <img src="docs/screenshots/notification.png" width="400" alt="Desktop notification confirming save">
</p>

Press `Alt+1` anywhere to save instantly — desktop notification confirms the action.
...
<p align="center">
  <img src="docs/screenshots/notification.png" width="400" alt="桌面通知确认保存">
</p>

在任何地方按 `Alt+1` 即可保存 — 桌面通知确认操作。
